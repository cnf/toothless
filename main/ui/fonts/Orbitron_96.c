 ...
 * Size: 96 px
 * Bpp: 1
 * Opts: --bpp 1 --size 96 --no-compress --stride 1 --align 1 --font Orbitron-Bold.ttf --symbols 0123456789:.,C° --format lvgl -o Orbitron_96.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xfe, 0xff, 0xf7, 0xff, 0x3f, 0xf1, 0xff,
    0x8f, 0xf8, 0x7f, 0x3, 0xf0, 0x1e, 0x0, 0x80,
    0x0,
    ...
    /* U+00B0 "°" */
    0x0, 0x3f, 0xff, 0x80, 0x0, 0x3f, 0xff, 0xfe,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 349, .box_w = 13, .box_h = 25, .ofs_x = 5, .ofs_y = -13},
    {.bitmap_index = 41, .adv_w = 349, .box_w = 13, .box_h = 12, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 61, .adv_w = 1281, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 665, .adv_w = 601, .box_w = 35, .box_h = 70, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 972, .adv_w = 1275, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 1576, .adv_w = 1269, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 2180, .adv_w = 1121, .box_w = 66, .box_h = 70, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2758, .adv_w = 1275, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 3362, .adv_w = 1260, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 3966, .adv_w = 1014, .box_w = 58, .box_h = 70, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4474, .adv_w = 1281, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 5078, .adv_w = 1272, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 5682, .adv_w = 364, .box_w = 13, .box_h = 56, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 5773, .adv_w = 1263, .box_w = 69, .box_h = 70, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 6377, .adv_w = 674, .box_w = 35, .box_h = 34, .ofs_x = 4, .ofs_y = 35}
};
