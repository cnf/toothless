...
// esp_err_t SettingsScreen::LocalCreateTitle() {
...
// esp_err_t SettingsScreen::LocalCreateMenu() {
...
//   _labels->section = lv_menu_section_create(_labels->root_page);

//   BuildSettingsUI(_labels->menu, "ui");

//   CreateSubMode(_labels->menu, _labels->section);
//   CreateSubDisplay(_labels->menu, _labels->section);

//   CreateText(_labels->root_page, NULL, "Info", LV_MENU_ITEM_BUILDER_VARIANT_1);
//   _labels->section = lv_menu_section_create(_labels->root_page);
//   CreateSubFirmwareInfo(_labels->menu, _labels->section);
//   lv_obj_t* sidebar_switch = CreateSwitch(_labels->section, LV_SYMBOL_SETTINGS, NULL, _labels->sidebar);
...
//   lv_obj_t* cont = CreateText(section, LV_SYMBOL_LIST, "Mode", LV_MENU_ITEM_BUILDER_VARIANT_1);
...
//   lv_obj_t* cont = CreateText(section, LV_SYMBOL_VIDEO, "Display", LV_MENU_ITEM_BUILDER_VARIANT_1);
